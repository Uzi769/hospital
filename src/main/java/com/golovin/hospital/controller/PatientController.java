...
import com.golovin.hospital.repository.specification.PatientRepositoryCriteria;
...
public class PatientController {
    ...
    private final PatientRepositoryCriteria patientRepositoryCriteria;
    ...
    public List<PatientResponse> getAll() {
        patientRepositoryCriteria.filter();
